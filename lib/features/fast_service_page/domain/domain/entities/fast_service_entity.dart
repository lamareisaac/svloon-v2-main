...
class ServicesEntity extends Equatable{
  ...
  ServicesEntity({ this.id,  this.title,  this.description,  this.price,  this.isPromo,  this.imageUrl,  this.createdAt,  this.updatedAt,  this.serviceTypeId,  this.salonId,});
